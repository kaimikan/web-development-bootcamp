...
// doing it with middleware instead of the post method as the steps suggest
// want to display a name as soon as the page loads the first time
let bandName = '';

function generateBandName(req, res, next) {
  let randomAdjective = adj[Math.round(Math.random() * adj.length)];
...
app.get('/', (req, res) => {
  ...
  res.render('index.ejs', { bndName: undefined });
});
...
app.post('/submit', (req, res) => {
  ...
  res.render('index.ejs', { bndName: bandName });
